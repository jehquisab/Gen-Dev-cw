...
public class CheckMySubmission {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n\n2025 END OF SUBMISSION CHECK: Please read the output above carefully.");
	}

	private static void contribution() {
		System.out.println("Checking your Contribution File Submission");
		System.out.println("------------------------------");
		String fname = "contribution-and-ai/Contribution-and-AI.txt";
		...
		System.out.println("   It looks like your contribution and AI file contains " + numWords + " words.");
		if (numWords == 0) {
	...
	private static void task1() {
		System.out.println("Checking your Task 1 Submission");
		System.out.println("------------------------------");
		...
		int numWords = countWordsUsingSplit(content);
		System.out.println("   It looks like your description file contains " + numWords + " of max 600 words. Please note that this does not count words per section - and instead only looks at the overall word count. Please ensure you meet the word count of each section!");
		if (numWords < 350) {
			System.out.println("   WARNING The number of words is a bit low.");
		}
